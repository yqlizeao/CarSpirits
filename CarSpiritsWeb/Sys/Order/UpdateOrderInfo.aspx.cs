...
namespace CarSpiritsWeb.Sys.Order
{
    public partial class UpdateOrderInfo : System.Web.UI.Page
    {
        ...
        private void DelData()
        {
            ...
            {
                int delNum = DataHandler.DelData("OrderInfo", selectID);
                if (delNum > 0)
                {
        ...
        private void QueryData()
        {
            ...
            DataSet dsCustomer = DataHandler.GetList("OrderInfo", "*", "ID", size, page, false, false, strWhere);
