<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerCarInfo.aspx.cs" Inherits="CarSpiritsWeb.Sys.Customer.CustomerCarInfo" %>
        ...
        function InitGird() {
            $('#tab_list').datagrid({
                ...
                columns: [[
                    ...
                    { title: '油量', field: 'JSON_油量', width: 100, align: 'center' },
                    { title: '里数', field: 'JSON_里数', width: 100, align: 'center' },
                    { title: '车身维护信息', field: 'JSON_车身维护信息', width: 150, align: 'center' },
                ]],
                toolbar: "#tab_toolbar",
